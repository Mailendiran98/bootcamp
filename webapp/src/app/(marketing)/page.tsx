...
export default function Home() {
  return (
    <div className="relative flex flex-col min-h-screen bg-[#05050f] text-white">
      {/* Background Glow */}
      <Starfield />
      ...
      <main className="flex-1">
        ...
        <section className="pt-32 pb-20 md:pt-48 md:pb-32 px-4 relative">
          <div className="container mx-auto max-w-5xl text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6 leading-tight">
              ...
              <span className="landing-text-gradient">— Before Anyone Else Does</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
              ...
              <Link href="/login" className="w-full sm:w-auto px-8 py-3 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 text-white font-medium transition-colors flex items-center justify-center gap-2">
                View Demo Dashboard
              </Link>
            </div>
              ...
              <div className="rounded-xl border border-white/10 bg-[#0a0a1a] shadow-2xl shadow-purple-900/20 overflow-hidden relative">
                ...
                <div className="h-12 border-b border-white/10 bg-white/5 flex items-center px-4 gap-2">
                  ...
                  <div className="mx-auto bg-white/5 rounded-md px-3 py-1 text-xs text-white/40 flex items-center gap-2">
                    ...
                    pipelinepulse.vercel.app/dashboard
                  </div>
                </div>
                ...
                <div className="p-8 grid gap-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                      ...
                      <div className="text-xs text-green-400 mt-2">&uarr; 12% from yesterday</div>
                    </div>
                    <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                      <div className="flex items-center gap-2 text-white/60 mb-2 text-sm">
        ...
        <section className="py-24 relative z-10 border-t border-white/5">
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-bold mb-6">Modern Data Teams <span className="landing-text-gradient">Lack Clear Visibility</span></h2>
          ...
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="p-8 border border-white/10 rounded-3xl bg-[#0a0a1a]">
                ...
                <Link href="/signup" className="block w-full py-3 px-4 bg-white/5 rounded-xl font-medium transition-colors hover:bg-white/10 text-center">Get Started</Link>
              </div>
              <div className="p-8 border border-purple-500/50 rounded-3xl bg-purple-900/10 relative">
                ...
                <Link href="/signup" className="block w-full py-3 px-4 bg-purple-600 rounded-xl font-medium transition-colors hover:bg-purple-500 text-center">Start Free Trial</Link>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-32 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Stop discovering data problems <br /><span className="landing-text-gradient">after your dashboards break.</span></h2>
      ...
      <footer className="py-8 text-center border-t border-white/10 text-white/40 text-sm">
        <p>&copy; 2026 PipelinePulse. All rights reserved.</p>
      </footer>
    </div>
  );
}
